...
var main = function __do() {
    ...
    var v3 = Merge.link();
    return Signal.runSignal(Signal.flippedMap(Signal.functorSignal)(Signal.merge(v2)(v3))(Merge.displayBoxValue))();
};
module.exports = {
    main: main
};

},{"../Control.Bind":8,"../Control.Monad.Eff":17,"../Control.Monad.Eff.Console":13,"../DOM":22,"../Data.Function":35,"../Data.Show":65,"../Data.String":69,"../Merge":75,"../Mouse":77,"../Prelude":78,"../Signal":84,"../TextCount":86}],74:[function(require,module,exports){
