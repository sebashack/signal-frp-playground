...
var main = function __do() {
    ...
    return Signal.runSignal(Signal.flippedMap(Signal.functorSignal)(Signal.merge(v6)(v7))(Accumulator.displayAccumValue))();
};
module.exports = {
    main: main
};

},{"../Accumulator":3,"../Control.Bind":10,"../Control.Monad.Eff":19,"../Control.Monad.Eff.Console":15,"../DOM":24,"../Data.Function":37,"../Data.Show":67,"../Data.String":71,"../Merge":77,"../Mouse":79,"../Prelude":80,"../Signal":86,"../SnapShot":88,"../TextCount":90}],76:[function(require,module,exports){
